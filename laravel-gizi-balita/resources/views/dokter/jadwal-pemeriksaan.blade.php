...
@section('title', 'Jadwal Pemeriksaan - GiziAnak')
...
<style>
    ...
    .patient-detail { font-size: 13px; color: #64748b; margin: 0; display: flex; align-items: center; gap: 6px; }
    ...
    .badge-selesai { background: #f0fdf4; color: #10b981; border: 1px solid #dcfce7; }
    .badge-rujukan { background: #fef2f2; color: #dc2626; border: 1px solid #fee2e2; }

    .action-block { min-width: 150px; text-align: right; }
    .btn-action { padding: 10px 16px; border-radius: 10px; font-size: 13px; font-weight: 700; cursor: pointer; border: none; transition: all 0.2s; width: 100%; text-align: center; }
...
<div class="page-header">
    <div class="header-title-group">
        ...
        <p>Daftar pasien yang akan melakukan pemeriksaan medis dengan Anda.</p>
    </div>
</div>
...
<div class="top-controls">
    <div class="date-picker-wrapper">
        ...
        <span class="current-date">Hari Ini, 5 Mei 2026</span>
        <button class="btn-nav-date">▶</button>
    </div>
...
<div class="schedule-list-container">
    ...
    <!-- Baris 1 (Pemeriksaan Mandiri) -->
    <div class="schedule-row">
        <div class="time-block">
            <h3 class="time-val">09:30</h3>
            <span class="time-am-pm">WIB</span>
        </div>
        <div class="patient-block">
            <div class="patient-header">
                <h3 class="p-name">Fajar</h3>
                <span class="p-age">3 Tahun</span>
            </div>
            <p class="patient-detail">Keluhan: Demam tinggi 2 hari, nafsu makan turun.</p>
        </div>
        <div class="status-block">
            <span class="badge badge-menunggu">⏳ Menunggu Sesi</span>
        </div>
        <div class="action-block">
            <button class="btn-action btn-start">Periksa Pasien</button>
        </div>
    </div>
    ...
    <div class="schedule-row">
        <div class="time-block">
            <h3 class="time-val">10:45</h3>
            <span class="time-am-pm">WIB</span>
        </div>
        <div class="patient-block">
            <div class="patient-header">
                <h3 class="p-name">Kevin</h3>
                <span class="p-age">1 Tahun</span>
            </div>
            <p class="patient-detail">Keperluan: Imunisasi Campak & Polio rutin.</p>
        </div>
        <div class="status-block">
            <span class="badge badge-menunggu">⏳ Menunggu Sesi</span>
        </div>
